    ...
    : TestsBase<OrgUnitsSeedDataClass, PeopleDbContext, Program>, IClassFixture<PeopleWebApplicationFactory<Program>>
{
  ...
  //   orgUnit.FormedDate.Should().BeAfter(testStart);
  ...
  //   Assert.Contains(orgUnits, t => t.Name == _seedData.ExistingOrgUnit.Name);
  // }
  ...
  //   // Act
  //   var orgUnit = await _client.GetFromJsonAsync<OrgUnitDto>($"{_path}/{_seedData.ExistingOrgUnit.Id}", _options);

  //   // Assert
  //   Assert.NotNull(orgUnit);
  //   Assert.Equal(orgUnit.Name, _seedData.ExistingOrgUnit.Name);
  // }
  ...
  // {
  //   // Arrange
  //   var orgUnit = _seedData.OrgUnitToUpdate;
  ...
  {
    // Arrange
    var orgUnit = _seedData.OrgUnitToDelete;
    ...
    Assert.NotNull(orgUnits);
    Assert.DoesNotContain(orgUnits, t => t.Name == orgUnit.Name);
  }
}

public class OrgUnitsSeedDataClass : ISeedDataClass<PeopleDbContext>
{
  public OrgUnit ExistingOrgUnit = null!;
  public OrgUnit OrgUnitToUpdate = null!;
  public OrgUnit OrgUnitToDelete = null!;
  ...
  public void InitializeDbForTests(PeopleDbContext db)
  {
    ...
    ExistingOrgUnit = db.OrgUnits.Add(new OrgUnit
    {
      Name = "Existing OrgUnit",
      FormedDate = DateTime.UtcNow,
      DisbandedDate = null
    }).Entity;

    OrgUnitToUpdate = db.OrgUnits.Add(new OrgUnit
    {
      Name = "Existing OrgUnit To Update",
      FormedDate = DateTime.UtcNow,
      DisbandedDate = null
    }).Entity;

    OrgUnitToDelete = db.OrgUnits.Add(new OrgUnit
    {
      Name = "Org Unit To Delete",
      FormedDate = DateTime.UtcNow,
      DisbandedDate = null
    }).Entity;
